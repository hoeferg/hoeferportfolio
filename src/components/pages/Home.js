...
export default function Home() {
    return (
        ...
        <div>
            <section>
                <h1>Gayle Hoefer</h1>
                <div id="id-card" class="w3-center w3-container w3-theme-l2 w3-col s11 l2 w3-round-large w3-card">
                    <img class="w3-col s10 w3-margin-top w3-round" src="./assets/images/IMG_0372.jpg" alt="" style="float: none;" />
                    <figcaption class="w3-large w3-col s12" />
                    <h2>Gayle Hoefer</h2>
                </div>
            </section>

            <section id="welcome" class=" w3-container w3-theme-l3 w3-col s11 l9 w3-round-large">
                <article class="w3-margin-top w3-container w3-margin-bottom w3-theme-d2 w3-col s12 l12 w3-round-xlarge w3-card-4" >
                    <h2 class="w3-center">
                        Welcome!</h2>
